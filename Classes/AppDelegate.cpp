...
static cocos2d::Size resourceResolutionSize = cocos2d::Size(480, 800);
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("insurance", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
        glview = GLViewImpl::create("insurance");
#endif
    ...
    //{
    director->setContentScaleFactor(MIN(resourceResolutionSize.height/designResolutionSize.height, resourceResolutionSize.width/designResolutionSize.width));
